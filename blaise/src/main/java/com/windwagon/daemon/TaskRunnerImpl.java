...
public class TaskRunnerImpl implements TaskRunner {
	...
	public void init() {
		...
		successMailSender = templateMailSenderFactory.getTemplateMailSender(task.getEnvKey() + Maestro.ENV_MAIL_SUCCESS_SUFFIX);
		errorMailSender = templateMailSenderFactory.getTemplateMailSender(task.getEnvKey() + Maestro.ENV_MAIL_ERROR_SUFFIX);
