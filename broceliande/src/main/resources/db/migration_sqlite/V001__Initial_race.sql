...
-- TIP: You can not add a foreign key to a table using ALTER TABLE because
-- SQLite does not support ADD CONSTRAINT in the ALTER TABLE statement.
-- The SQLite ALTER command only supports "rename table" and "add column".
-- ww_sequence_id
--
...
CREATE TABLE ww_meeting (
    ...
    FOREIGN KEY (racecourse) REFERENCES ww_racecourse(id)
);
...
CREATE TABLE ww_race (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (meeting) REFERENCES ww_meeting(id)
);
...
CREATE TABLE ww_racetypes (
    ...
    FOREIGN KEY (race) REFERENCES ww_race(id)
);
...
CREATE TABLE ww_simple (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (odds) REFERENCES ww_odds(id)
);
...
CREATE TABLE ww_horse (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (horse_id) REFERENCES ww_horseid(id),
    FOREIGN KEY (jockey) REFERENCES ww_jockey(id),
    FOREIGN KEY (owner) REFERENCES ww_owner(id),
    FOREIGN KEY (rancher) REFERENCES ww_rancher(id),
    FOREIGN KEY (trainer) REFERENCES ww_trainer(id),
    FOREIGN KEY (race) REFERENCES ww_race(id)
