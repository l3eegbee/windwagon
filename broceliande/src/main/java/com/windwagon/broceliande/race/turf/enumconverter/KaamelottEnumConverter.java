...
public abstract class KaamelottEnumConverter < K extends Enum<K>, B extends Enum<B>> {
    ...
    public static class WindDirectionEnumConverter extends
            KaamelottEnumConverter<com.windwagon.kaamelott.race.WindDirection, WindDirection> {
        ...
        protected com.windwagon.kaamelott.race.WindDirection getKaamelottValue( Field field ) {
            ...
            if( anno == null )
                throw new RuntimeException( "No associated field for " + field );
    ...
    public static class FieldEnumConverter extends
            KaamelottEnumConverter<com.windwagon.kaamelott.race.Field, com.windwagon.broceliande.race.entities.Field> {
    ...
    public static class DisciplineEnumConverter extends
            KaamelottEnumConverter<com.windwagon.kaamelott.race.Discipline, Discipline> {
    ...
    public static class RaceTypeEnumConverter extends
            KaamelottEnumConverter<com.windwagon.kaamelott.race.RaceType, Type> {
    ...
    public static class BetTypeEnumConverter extends
            KaamelottEnumConverter<com.windwagon.kaamelott.race.BetType, BetType> {
    ...
    public static class PriceNameEnumConverter extends
            KaamelottEnumConverter<com.windwagon.kaamelott.race.PriceName, PriceName> {
    ...
    public static class BlinderEnumConverter extends
            KaamelottEnumConverter<com.windwagon.kaamelott.race.Blinder, Blinder> {
    ...
    public static class HorseshoeEnumConverter extends
            KaamelottEnumConverter<com.windwagon.kaamelott.race.Horseshoe, Horseshoe> {
