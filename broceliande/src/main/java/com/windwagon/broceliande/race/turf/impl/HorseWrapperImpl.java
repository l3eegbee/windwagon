...
public class HorseWrapperImpl extends ObjectWrapperImpl<Horse> implements HorseWrapper {
    ...
    public final static Comparator<com.windwagon.kaamelott.race.Horse> COMPARATOR =
            Comparator.comparing( com.windwagon.kaamelott.race.Horse::getRace ).thenComparingInt(
                    com.windwagon.kaamelott.race.Horse::getNumber );

    @Autowired
    private HorseRepository horseRepository;

    private LazyInitializer<HorseIDWrapper> horseIDWrapper = new LazyInitializer<HorseIDWrapper>(
            () -> stud.getHorseID( ref, daoObject.getHorseID() ) );
    ...
    static public int compare(
            com.windwagon.kaamelott.race.Horse h1,
            com.windwagon.kaamelott.race.Horse h2 ) {
    ...
    LazyInitializer<RaceWrapper> race = new LazyInitializer<RaceWrapper>(
            () -> stud.getRace( ref, daoObject.getRace(), this ) );
    ...
    public Iterator<com.windwagon.kaamelott.race.Horse> getHistory() {
        List<Horse> listHorse =
                horseRepository.getHorseHistory( daoObject.getHorseID(), ref.getNow() );
    ...
    private LazyInitializer<com.windwagon.kaamelott.race.Sex> sex = new LazyInitializer<>( () -> {
        ...
        if( sex == Sex.MALE ) {
            ...
            if( gdate != null && !gdate.after( today ) )
                sex = Sex.GELDING;
        }
    ...
    private LazyInitializer<String> trainer =
            new LazyInitializer<String>( () -> daoObject.getTrainer().getName() );
    ...
    public Iterator<com.windwagon.kaamelott.race.Horse> getTrainerHistory() {
        List<Horse> listHorse =
                horseRepository.getTrainerHistory( daoObject.getTrainer(), ref.getNow() );
        return stud.iterate( ref, listHorse );
    }

    private LazyInitializer<String> owner =
            new LazyInitializer<String>( () -> daoObject.getOwner().getName() );
    ...
    public Iterator<com.windwagon.kaamelott.race.Horse> getOwnerHistory() {
        List<Horse> listHorse =
                horseRepository.getOwnerHistory( daoObject.getOwner(), ref.getNow() );
        return stud.iterate( ref, listHorse );
    }

    private LazyInitializer<String> rancher =
            new LazyInitializer<String>( () -> daoObject.getRancher().getName() );
    ...
    public Iterator<com.windwagon.kaamelott.race.Horse> getRancherHistory() {
        List<Horse> listHorse =
                horseRepository.getRancherHistory( daoObject.getRancher(), ref.getNow() );
        return stud.iterate( ref, listHorse );
    }

    private LazyInitializer<String> jockey =
            new LazyInitializer<String>( () -> daoObject.getJockey().getName() );
    ...
    public Iterator<com.windwagon.kaamelott.race.Horse> getJockeyHistory() {
        List<Horse> listHorse =
                horseRepository.getJockeyHistory( daoObject.getJockey(), ref.getNow() );
        return stud.iterate( ref, listHorse );
    }
    ...
    public Double getStableOddsValue( Date date ) {
        ...
        String target =
                ( stable == null || stable.isEmpty() ) ? daoObject.getNumber().toString() : stable;
    ...
    public Double getOddsValue( Date date, String target ) {
        ...
        for( Simple simple : odds.getSimples() )
            if( simple.getNumber().equals( target ) )
    ...
    public Place getPlace() {
        ...
        for( Place place : places )
            if( place.getHorse().equals( daoObject ) )
                return place;
    ...
    private LazyInitializer<Integer> finishPosition =
            new LazyInitializer<Integer>( () -> getPlace().getNumber() );
    ...
    private LazyInitializer<Integer> finishDuration =
            new LazyInitializer<Integer>( () -> getPlace().getDuration() );
    ...
    private LazyInitializer<Boolean> stopped =
            new LazyInitializer<Boolean>( () -> getRace().getStopped().contains( this ) );
    ...
    private LazyInitializer<Boolean> disqualified =
            new LazyInitializer<Boolean>( () -> getRace().getDisqualified().contains( this ) );
    ...
    private LazyInitializer<Boolean> fallen =
            new LazyInitializer<Boolean>( () -> getRace().getFallen().contains( this ) );
