...
public class BetCheckerTest {
	...
	private void checkValidity(boolean shouldBeValid, RaceWrapper race, BetType betType, double stake, int... horseNums) {
	...
	private void testBet(RaceWrapper race, double rapport, BetType betType, double stake, int... horseNums) throws InvalidBet {

		Bet bet = createBet(race, betType, stake, horseNums);

		assertThat(1d + race.getBalance(bet) / stake, is(closeTo(rapport, BetChecker.DOUBLE_TOLERANCE)));
