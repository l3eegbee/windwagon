...
public class Meeting_20150813_M6 extends MeetingBuilder {
	...
	public static Race builderRace_R1(Meeting meeting) {
		...
		// -- bets --
		race.setBets(EnumSet.of(BetType.SIMPLE_GAGNANT, BetType.SIMPLE_PLACE, BetType.COUPLE_GAGNANT, BetType.COUPLE_PLACE, BetType.TRIO));
	...
	public static Race builderRace_R4(Meeting meeting) {
		...
		race.setBenefit(11000.0);
		race.setDiscipline(Discipline.TROT_ATTELE);
		race.setTypes(EnumSet.of(Type.RECLAMER, Type.APPRENTIS, Type.LADS_JOCKEYS));
		// -- horses --
		SortedSet<Horse> horses = new TreeSet<>();
	...
	public static Race builderRace_R6(Meeting meeting) {
		...
		// -- bets --
		race.setBets(EnumSet.of(BetType.SIMPLE_GAGNANT, BetType.SIMPLE_PLACE, BetType.COUPLE_GAGNANT, BetType.COUPLE_PLACE, BetType.TRIO, BetType.MULTI_EN_QUATRE, BetType.MULTI_EN_CINQ, BetType.MULTI_EN_SIX, BetType.QUARTE));
	...
	public static Race builderRace_R7(Meeting meeting) {
		...
		race.setDiscipline(Discipline.TROT_ATTELE);
		race.setTypes(EnumSet.of(Type.RECLAMER, Type.AMATEURS));
		// -- horses --
		SortedSet<Horse> horses = new TreeSet<>();
