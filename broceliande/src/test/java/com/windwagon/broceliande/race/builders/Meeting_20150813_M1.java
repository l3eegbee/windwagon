...
public class Meeting_20150813_M1 extends MeetingBuilder {
	...
	public static Race builderRace_R1(Meeting meeting) {
		...
		// -- bets --
		race.setBets(EnumSet.of(BetType.SIMPLE_GAGNANT, BetType.SIMPLE_PLACE, BetType.COUPLE_ORDRE, BetType.TRIO_ORDRE));
	...
	public static Race builderRace_R3(Meeting meeting) {
		...
		// -- bets --
		race.setBets(EnumSet.of(BetType.SIMPLE_GAGNANT, BetType.SIMPLE_PLACE, BetType.COUPLE_ORDRE, BetType.COUPLE_GAGNANT, BetType.COUPLE_PLACE, BetType.TRIO, BetType.DEUX_SUR_QUATRE, BetType.MULTI_EN_QUATRE, BetType.MULTI_EN_CINQ, BetType.MULTI_EN_SIX, BetType.MULTI_EN_SEPT, BetType.TIERCE, BetType.QUARTE, BetType.QUINTE));
	...
	public static Race builderRace_R5(Meeting meeting) {
		...
		// -- bets --
		race.setBets(EnumSet.of(BetType.SIMPLE_GAGNANT, BetType.SIMPLE_PLACE, BetType.COUPLE_ORDRE, BetType.COUPLE_GAGNANT, BetType.COUPLE_PLACE, BetType.TRIO, BetType.DEUX_SUR_QUATRE, BetType.MULTI_EN_QUATRE, BetType.MULTI_EN_CINQ, BetType.MULTI_EN_SIX, BetType.PICK5, BetType.TIERCE));
