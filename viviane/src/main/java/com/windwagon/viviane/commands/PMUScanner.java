...
public class PMUScanner implements CommandMarker {
	...
	public String pmuScan(@CliOption(key = {"", "date", "from"}, help = "Date (dd-mm-yyyy)") String from, @CliOption(key = "to", help = "Date (dd-mm-yyyy)", mandatory = false) String to) {
	...
	public String meetingBuilder(@CliOption(key = {""}, help = "Root directory", unspecifiedDefaultValue = ".") String directory) throws IOException {
